...
PDT_LIST = [1, 2, 3, 4, 5, 7, 14, 21, 28, 30, 35, 40, 45, 50, 55, 60, 70, 80, 90, 180, 365, 545]  # daily carbon
...
for PDT in PDT_LIST:
    ...
    results.to_csv(output_dir / f'MOIRAI_{args.run_name}_pl{PDT}_feat{past_col_len}_{stage}.csv',
                   index=False)
